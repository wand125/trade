    ...
    *,
    ...
    if compile_status and compile_status.get("all_compiled_fresh") is False:
        return (
            ...
            False,
            "Run methods/swing_eval/analysis/mt5_compile.py before launching Strategy Tester.",
        )
    ...
    if not latest_run.get("exists"):
        return (
            "missing_latest_run",
            False,
            "Run methods/swing_eval/analysis/mt5_tester_run.py to create the latest tester evidence.",
        )
    ...
    if latest_run.get("blocked") is True:
        if components.get("compile_stale") is True:
            return ("blocked_compile_stale", False, "Run methods/swing_eval/analysis/mt5_compile.py before rerunning MT5 Tester.")
