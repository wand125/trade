...
DEFAULT_CONFIG = "methods/swing_eval/mt5/TesterConfigs/Swing_Evaluation_Trader_next_optimization.ini"
...
def resolve_expert_parameters_set(
    *,
    ...
    if raw.is_absolute():
        return raw
    candidates = [
        workspace / "methods" / "swing_eval" / "mt5" / "TesterSets" / text,
        config.parent / text,
        workspace / text,
    ]
    ...
    *,
    ...
    if tester_set_sync_blocked:
        warnings.append(
            ...
            "or copy the workspace methods/swing_eval/mt5/TesterSets preset into MQL5/Profiles/Tester before launch"
        )
