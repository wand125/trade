...
DEFAULT_TEMPLATE_SET = "methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_optimization.set"
DEFAULT_OUTPUT_SET = "methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set"
SIDE_NAMES = ("buy", "sell")
