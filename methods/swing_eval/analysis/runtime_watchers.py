...
def runtime_watcher_manager_command(
    *,
    ...
    command = [
        python_executable,
        "methods/swing_eval/analysis/runtime_watchers.py",
        "--only",
        watcher_name,
        "--interval-seconds",
        str(interval_seconds),
