...
| 用途 | ファイル | MT5配置先 | 発注 |
|---|---|---|---|
| 予測表示だけ | `methods/swing_eval/mt5/Indicators/Swing_Evaluation_Predictor.mq5` | `MQL5/Indicators` | しない |
| MT5単体Forward/Strategy Tester | `methods/swing_eval/mt5/Experts/Swing_Evaluation_Trader.mq5` | `MQL5/Experts` | 初期状態ではしない |
| Bridgeでruntime取得 | `methods/swing_eval/mt5/Experts/AI_Bridge_Advisor.mq5` | `MQL5/Experts` | 初期状態ではしない |
...
```text
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_backtest.set
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_forward_test.set
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_sample_collection.set
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_optimization.set
...
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set
methods/swing_eval/mt5/TesterSets/Swing_Evaluation_Trader_buy_entry_refit.set
