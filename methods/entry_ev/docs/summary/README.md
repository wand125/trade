...
`methods/entry_ev/docs/reports/` を読む前の入口。summaryでは詳細な実験ログを再掲せず、現在の判断、研究レーン、読む順番だけを管理する。
...
2. [Report Map](report_map.md)
   `00001` から `00347` までのレポートを研究レーン別に圧縮した地図。
