...
## 現在の状態(2026-08-06 07:56 JST 更新)

- 口座: Titan FX 9181575。残高401,505円(作戦01第1次 +100円決済済み)
- **作戦01 第1次**: 決済完了(2026-08-06 02:11、建値ストップ、確定+100円)
- **作戦01 第2次(指値設置済み、2026-08-06 07:41 JST)**:
  - 注文 **89812483**: Sell Limit 20ロット @157.80 SL **159.00** TP 157.20
  - 注文 **89812489**: Sell Limit 20ロット @157.80 SL **159.00** TP 155.80
  - **トレーリング新ルール(2026-08-06合意、建値ストップは廃止)**: 「+30pips到達(157.50到達) or 日中安値157.31割れ」のいずれか早い方で**両玉SLを158.15へ**移動。TP1(157.20)約定後は残玉SLを157.50へ引き下げ(従来通り)
- **作戦03**: XAUUSD-m Buy Limit 0.3ロット @4,230 SL4,220 TP4,264(注文89802354)、未約定継続中。デイリーブレイク(JST6-7時)を跨いだが約定なし。金は8/6朝時点4,240〜4,260台で推移(指値まで距離あり)
