...
最終更新: **2026-08-07 21:55 JST(作戦06の委任執行を移管。以前の作戦01/02の玉はすべて決済済み)**
...
- 口座: Titan FX 9181575。残高 **378,855円**
- **ポジション・注文ともにゼロ**。作戦01/02/03/04/05 はすべて終了済み(結果は campaign.md)
...
- **作戦06(NFP後の順張り自動設置)が稼働中** — 下記「作戦06の執行」節がこのセッションの主務

## 作戦06の執行(2026-08-07 移管、**8/8 06:00 JST で自動失効**)
