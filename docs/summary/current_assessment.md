...
2. `refit2025 2025-03` はsupport-sufficient negative monthとして、既存tradeのreplacement / early exit / EV過大評価補正を扱う別レーンを作る。00318 thin-support candidate generationへ混ぜない。
