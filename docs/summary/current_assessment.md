...
1. Prior/OOB reliability calibrationを作る。fresh03で見えたPnL / beats60 signalとtail-loss calibrationを分離し、tail penaltyはtrain countではなく過去OOF信頼性を見てから使う。
...
5. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00342 target labelsで診断する。単純fallback緩和、global early-support relaxation、train-count gateのpolicy化は本流にしない。
