...
1. 同一decision cluster内で、選んだ候補と近傍代替候補を比較するpairwise/listwise switching targetを作る。
2. harmful probabilityをhorizon / side / session / regime別にcalibrateし、global scalar penaltyとして使わない。
3. 00329 bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-11`, `refit2025 2025-03` を00331/00332 target labelsで診断する。単純fallback緩和は本流にしない。
