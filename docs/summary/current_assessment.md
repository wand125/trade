...
1. q95 + raw `loss_exit30_cd15` を固定benchmarkにしたまま、supervised exit-capture / realized-PnL shrinkage headを作る。
2. prior capture factor、loss-first probability、predicted holding、side confidence gap、regime/session/family、fixed-horizon proxyを特徴量として使う。
