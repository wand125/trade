...
1. `fresh2024 2024-03` のfallback/non-model horizon rowに対し、target-local confidence labelsを作る。oracle positiveは教師/診断に限定し、fallback採用へ飛ばない。
...
5. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00339 target labelsで診断する。単純fallback緩和は本流にしない。
