...
1. `ranker_pred_pnl < 0` horizon-switch vetoをpost-hoc診断からstateful replayへ戻す。plain `pnl`、`pnl_delta_tail_reliability_gated`、`pnl_tail_reliability_gated` を一玉制約とstandard admissionで比較する。
...
6. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00345 target labelsで診断する。単純fallback緩和、global early-support relaxation、train-count gate、reliability direct multiplierのpolicy化は本流にしない。
7. `hybrid2025 2025-10 long` のようなpositive predicted PnL failureへ、tail/overestimate/context reliability診断を追加する。
