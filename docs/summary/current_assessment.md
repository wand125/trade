...
1. 00335のleak-free replay baselineを基準に、listwise examplesをchronological training targetへ変換し、`actual_oracle_greedy_selected` やquota group内actual rankを教師にした低容量meta-selectorを作る。
2. fresh/thin month用の候補生成またはabstention層を作る。唯一候補が弱いときにsupport目的だけで入らない設計にする。
...
4. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-11`, `refit2025 2025-03` を00331/00332/00333/00334/00335 target labelsで診断する。単純fallback緩和は本流にしない。
