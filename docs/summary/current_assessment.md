...
1. `fresh2024 2024-03` のtarget-local confidence診断を広いsupport rowsへ拡張し、horizon-confidence headを作る。oracle positiveは教師/診断に限定し、fallback採用や固定240mへ飛ばない。
...
5. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00340 target labelsで診断する。単純fallback緩和は本流にしない。
