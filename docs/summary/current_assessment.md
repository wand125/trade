...
1. fixed60 positive predictionがactual short-horizon negativeになる型を、post-hoc actualではなく事前のuncertainty / calibration residual featureへ戻す。
