...
1. harmful probabilityを直接penaltyではなくsupport-aware objectiveのfeatureとして使う。
2. support-aware horizon-choice scoreを作る。例: `EV + support_reduction_value - harmful_risk_when_not_support_repair`。
3. 00329 bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-11`, `refit2025 2025-03` を00331 target labelsで診断する。単純fallback緩和は本流にしない。
