...
1. Prior/OOB reliabilityをdirect scoreではなくhead selection / abstention / confidence reportとして使う。fresh03で見えたPnL / beats60 signalとtail-loss calibrationを分離し、tail penaltyはtrain countや単純multiplierではなく過去OOF信頼性の診断として扱う。
...
5. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00343 target labelsで診断する。単純fallback緩和、global early-support relaxation、train-count gate、reliability direct multiplierのpolicy化は本流にしない。
