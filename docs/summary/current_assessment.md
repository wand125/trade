...
1. `positive_bias_and_tail_miss_ge_0p10` と `tail_prob_ge_0p30` をstateful replay sensitivityへ入れる。candidate aggregateではなくbest additions / selector blockersで評価する。
...
6. 00329/00335 leak-free bestのremaining weak months、特に `fresh2024 2024-03`, `fresh2024 2024-08`, `fresh2024 2024-11`, `refit2025 2025-03` を00331..00347 target labelsで診断する。単純fallback緩和、global early-support relaxation、train-count gate、reliability direct multiplier、stateful pred-pnl negative veto、pointwise positive-PnL gateのpolicy化は本流にしない。
