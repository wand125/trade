...
```text
Report: 00294 Entry EV Overlay Residual Floor Diagnostics
Status: accepted infrastructure / diagnostic candidate remains NoTrade
Question: 00293で残ったsmall negative monthsは追加block対象か、support/admission問題か
Best evidence: 4 negative monthsのうち3件が1 trade month / side share 1.0。refit2025 2025-03の主損失はfixed horizonで悪化し、同contextは全体プラス
Decision: 標準policyはNoTrade
Next: support-aware admission diagnosticsへ進む
```
