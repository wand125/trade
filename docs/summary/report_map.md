...
```text
Report: 00299 Entry EV Residual Combo Selected Trade Calibration
Status: accepted infrastructure / direct calibrated gate rejected
Question: residual combo branch上でchronological OOF expected PnL calibrationはgate品質まで持つか
Best evidence: raw EV MAE 10.7256 -> factor 2.9448 / PnL 3.0165。ただしSpearman低く、factor < 0 gateは+7.8728だけ
Decision: 標準policyはNoTrade
Next: calibration scoreはuncertainty / regime diagnostics / admission explanationへ回す
```
