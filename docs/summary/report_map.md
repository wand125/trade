...
```text
Report: 00328 Entry EV Broad Duration Prior Repair Replay
Status: accepted infrastructure / standard NoTrade
Question: broad candidate priorで悪い720m duration riskを事前に警告し、support repairに使えるか
Best evidence: fresh2024 2024-08の720m priorはmean -3.4993 / delta vs 60m -4.4053 / tail rate 0.4145で警告できる。ただしdirect penalty bestはcombined +363.0870で、勝ち候補も削る。
Decision: 標準policyはNoTrade
Next: broad priorを静的penaltyではなくchronological horizon-choice ranker/headのfeatureにする
```
