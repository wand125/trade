...
```text
Report: 00360 Entry EV Candidate Generation Gap Audit
Status: accepted infrastructure / standard NoTrade
Question: 残targetはcandidate generation pipelineのどこで落ちているか
Best evidence: fresh2024 2024-11はrole/month row 1だがavailable_candidates 0、greedy 1だけがrelaxed候補。refit2025 2025-03は00322 base/00358 rankerともprediction row 0。
Decision: 2024-11はrow-scope/candidate availability問題、2025-03はprediction-row universe coverage問題。標準policyはNoTrade
Next: 2024-11のavailable候補化と2025-03のupstream universe拡張を分けて試す
```
