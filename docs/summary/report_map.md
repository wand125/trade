...
```text
Report: 00297 Entry EV Month Warmup Overlay
Status: accepted infrastructure / diagnostic candidate remains NoTrade
Question: thin-support residual monthsを月内warmupで広く抑えられるか
Best evidence: skip_first_1はtotal +329.4348 -> +275.3470、month min -0.7200 -> -1.9596へ悪化
Decision: 標準policyはNoTrade
Next: broad warmupはrejectし、unused chronologyかmodel-level confidence/calibrationを優先
```
