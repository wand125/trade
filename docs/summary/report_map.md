...
| `00241` | EV-overestimate risk selector | 00240のEV overestimate target riskを候補selector featureへ戻した。strict/relaxed/sensitivity 480行は全てNoTrade。pointwiseではq95 floor5 fresh損失を拾うがrefit勝ちroleの利益も削るため、hard gateではなくranking/calibration headへ回す。 |
...
55. `00241_2026-07-01_entry_ev_overestimate_risk_selector.md`
