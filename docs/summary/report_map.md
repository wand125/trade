...
```text
Report: 00340 Entry EV Support Repair Target Local Confidence
Status: accepted infrastructure / standard NoTrade
Question: fresh2024 2024-03のfallback/non-model positivesは何を外しているか
Best evidence: fresh2024 2024-03 longは60m -137.9060、240m +49.0950、720m -99.9060。240mだけが正で、既存fallback予測はhorizon confidenceを選べていない。
Decision: 標準policyはNoTrade
Next: 広いsupport rowsでhorizon-confidence headと候補生成を追加
```
