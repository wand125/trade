...
```text
Report: 00289 Entry EV Hold Extension Target Model
Status: accepted infrastructure / diagnostic candidate
Question: fixed-horizon/hold-extension choiceはchronological supervised targetとして学べるか
Best evidence: isolated_loss training + isolated_large_loss threshold 5 flags 7 trades; no-replay total +246.7530 and month min -6.8324, but 2025-09/2025-06/hybrid 2025-12 remain unfixed
Decision: 標準policyはNoTrade
Next: exit-time hold-extension hookでfull stateful replayする
```
