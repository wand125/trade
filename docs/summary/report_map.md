...
```text
Report: 00307 Entry EV Short Entry-Block Replacement Replay
Status: accepted infrastructure / universal short replacement rejected
Question: no-replacement overlayで効いたshort entry-blockを未選択entry候補feed上のreplacement replayへ戻せるか
Best evidence: raw loss_exit30_cd15合算は baseline +118.6900 / 266 trades / month min -6.8324 から replacement +126.8118 / 254 trades / month min -6.8324 へ改善。hybrid 2025-12は -4.1460 -> +4.5000 だが internal+hgb total は +112.0660 -> +111.5418 と小幅悪化
Decision: 標準policyはNoTrade
Next: hold-extension state-dependent blockとside-aware hold-extension replacement統合へ戻す
```
