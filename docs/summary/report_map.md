...
```text
Report: 00300 Entry EV Calibration Residual Context Diagnostics
Status: accepted infrastructure / post-hoc blacklist rejected
Question: calibration後もどのcontextで過大評価とlarge lossが残るか
Best evidence: short|ny_late total -13.0136、long|range_normal_vol|ny_overlap total -12.5040。後者はtrain rows平均160.8でも外す
Decision: 標準policyはNoTrade
Next: prior-only context residual pressure / uncertainty headへ戻す
```
