...
```text
Report: 00359 Entry EV 00358 Thin Month Candidate Audit
Status: accepted infrastructure / standard NoTrade
Question: 00358後の残blockerはcandidate selection問題か、candidate generation問題か
Best evidence: 00358 EV2 bestのstateful surfaceは残target 4件に候補0。EV -2 + singletonは候補が2024-08に集中。00324 externalを足しても2024-11/refit2025-03は候補0。
Decision: 残blockerはglobal gate不足ではなくtarget-local calibration / fallback confidence / candidate generation不足。標準policyはNoTrade
Next: fresh2024 2024-11 / refit2025 2025-03のcandidate-generation pathとfresh2024 2024-03 fallback confidenceを作る
```
