...
24. selected-trade qualityのgroup平均下限gateは、過大評価の平均補正には効くが、未来月で良いtradeも落とす。次はgateではなく、校正EVへの置換、過大評価soft penalty、またはtrade failure分類targetとして使う。
