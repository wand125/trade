...
17. `long:ny_late` blockはvalidation top近傍に残り2024-12損失を大きく縮めるがNoTrade未満。単体rule採用ではなく、top min pnlからの許容劣化幅、未知月risk reduction、EV過大評価抑制を同時に扱うselection基準として検討する。
