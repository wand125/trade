...
1. 2024-12/2025-02の失敗tradeを entry方向、exit遅れ、EV過大評価、regime、時間帯に分解して診断する。
2. train期間にもOOF predictionsを作り、meta model/calibrationの学習量を増やす。
...
6. 追加holdout月を用意し、2024-12/2025-02に過剰適合しない評価へ移る。
