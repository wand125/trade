...
DEFAULT_SPEC_PATH = "docs/live/swing-evaluation-trading-system-spec.md"
...
MT5_STRATEGY_TESTER_LABEL_CONFIGS: dict[str, str] = {
    "sell_short_window": "mt5/TesterConfigs/Swing_Evaluation_Trader_optimization.ini",
    "sell_hour12_m30m15_2025": "mt5/TesterConfigs/Swing_Evaluation_Trader_sell_hour12_m30m15_validation.ini",
    "sell_hour12_m30m15_calendar_2025": (
        "mt5/TesterConfigs/Swing_Evaluation_Trader_sell_hour12_m30m15_calendar_validation.ini"
    ),
    "sell_regime_entry_2025": "mt5/TesterConfigs/Swing_Evaluation_Trader_sell_regime_entry_refit.ini",
    "buy_wide_stop_short": "mt5/TesterConfigs/Swing_Evaluation_Trader_buy_wide_stop_validation.ini",
...
MQL5_ARTIFACTS: tuple[tuple[str, str, str], ...] = (
    ("predictor_indicator", "mt5/Indicators/Swing_Evaluation_Predictor.mq5", "Phase 5.5"),
    ("standalone_trader_ea", "mt5/Experts/Swing_Evaluation_Trader.mq5", "Phase 6/7"),
    ("bridge_advisor_ea", "mt5/Experts/AI_Bridge_Advisor.mq5", "Phase 1/6"),
    ("backtest_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_backtest.ini", "MT5 Back/Forward"),
    ("forward_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_forward_test.ini", "MT5 Back/Forward"),
    ("strategy_test_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_strategy_test.ini", "MT5 Forward"),
    ("sample_collection_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_sample_collection.ini", "Score Weight"),
    ("optimization_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_optimization.ini", "MT5 Optimization"),
    ("next_optimization_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_next_optimization.ini", "MT5 Optimization"),
    ("stable_candidate_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_stable_candidate.ini", "MT5 Optimization"),
    ("buy_refit_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_buy_refit.ini", "BUY Refit"),
    ("buy_entry_refit_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_buy_entry_refit.ini", "BUY Refit"),
    (
    ...
    (
        ...
        "mt5/TesterConfigs/Swing_Evaluation_Trader_buy_score_weight_refit.ini",
        "Score Weight",
    ),
    ("sell_entry_refit_config", "mt5/TesterConfigs/Swing_Evaluation_Trader_sell_entry_refit.ini", "SELL Refit"),
    (
    ...
    (
        ...
        "mt5/TesterConfigs/Swing_Evaluation_Trader_sell_score_weight_refit.ini",
        "Score Weight",
    ),
    (
    ...
    ("backtest_set", "mt5/TesterSets/Swing_Evaluation_Trader_backtest.set", "MT5 Back/Forward"),
    ("forward_set", "mt5/TesterSets/Swing_Evaluation_Trader_forward_test.set", "MT5 Back/Forward"),
    ("sample_collection_set", "mt5/TesterSets/Swing_Evaluation_Trader_sample_collection.set", "Score Weight"),
    ("optimization_set", "mt5/TesterSets/Swing_Evaluation_Trader_optimization.set", "MT5 Optimization"),
    ("next_optimization_set", "mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set", "MT5 Optimization"),
    (
        "stable_candidate_set",
        "mt5/TesterSets/Swing_Evaluation_Trader_stable_candidate_next.set",
        "MT5 Optimization",
    ),
    ("buy_refit_set", "mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set", "BUY Refit"),
    ("buy_entry_refit_set", "mt5/TesterSets/Swing_Evaluation_Trader_buy_entry_refit.set", "BUY Refit"),
    (
    ...
    ("sell_entry_refit_set", "mt5/TesterSets/Swing_Evaluation_Trader_sell_entry_refit.set", "SELL Refit"),
    (
        ...
        components.append(
            {
                "name": filename,
                "line": line_number,
                "expected_path": f"analysis/{filename}",
            }
        )
    return components
...
def test_reference_count(workspace: Path, component_name: str) -> int:
    ...
    count = 0
    for test_file in sorted((workspace / "tests").glob("test_*.py")):
        try:
...
def bridge_recovery_refresh_commands(label_suffix: str) -> list[dict[str, str]]:
    return [
        command_step(
            ...
            "python3 analysis/bridge_status.py --output-json runtime/latest_bridge_status.json "
            "--output-md runtime/latest_bridge_status.md",
        ),
        command_step(
            f"refresh_bridge_recovery_plan_{label_suffix}",
            "python3 analysis/bridge_recovery_plan.py --bridge-status runtime/latest_bridge_status.json "
...
def build_spec_next_actions(
    *,
            ...
            actions,
            {
                ...
                "commands": [
                    command_step(
                        ...
                        "python3 analysis/mt5_compile_status.py --output-json runtime/latest_mt5_compile_status.json "
                        "--output-md runtime/latest_mt5_compile_status.md",
                    ),
                    command_step(
                        "rerun_spec_coverage",
                        "python3 analysis/spec_coverage.py --output-json runtime/latest_spec_coverage.json "
            ...
            actions,
            {
                ...
                "commands": [
                    command_step(
                        ...
                        "python3 analysis/mt5_compile.py --timeout-seconds 90 "
    ...
    if history_stale_or_missing:
        ...
        if history_request.get("pending") is True:
            ...
            if history_request.get("stale_pending") is True:
                ...
                if snapshot.get("fresh") is False:
                    manual_steps.append(
                        "latest_snapshot.json is stale, so the bridge/EA connection is probably not posting current snapshots."
                    )
        ...
        elif (workspace / "bridge" / "request_history.py").exists():
            commands.append(command_step("request_history", "python3 bridge/request_history.py 168"))
        if history_request.get("stale_pending") is True:
        ...
        commands.append(
            command_step(
                ...
                "python3 analysis/history_status.py --history runtime/latest_history_168h.json "
    ...
    if bridge_not_ready_reasons or bridge_activity_reasons or bridge_watch_activity_missing:
        ...
        if bridge_status == "ea_not_posting":
            ...
            manual_steps.append("Start or restart python3 bridge/mt5_ai_bridge.py, then check /health and /config.")
        elif bridge_status == "bridge_process_not_found":
            manual_steps.append("Start python3 bridge/mt5_ai_bridge.py before waiting for EA history responses.")
        ...
        if bridge_watch_activity_missing:
            commands.append(
                command_step(
                    ...
                    "python3 analysis/bridge_status_watch.py --interval-seconds 60 "
    ...
    if runtime_watchers_reasons:
        ...
        commands = [
            command_step(
                ...
                "python3 analysis/runtime_watchers.py --interval-seconds 60 "
            ...
            command_step(
                ...
                "python3 analysis/runtime_watchers.py --interval-seconds 60 --restart "
                "--output-json runtime/latest_runtime_watchers.json "
                "--output-md runtime/latest_runtime_watchers.md",
            ),
        ]
    ...
    if winrate_fit_stale_or_missing or risk_shape_stale_or_missing:
        ...
        if winrate_fit_stale_or_missing:
            ...
            commands.append(
                command_step(
                    "refresh_winrate_fit",
                    "python3 analysis/winrate_fit.py --history runtime/latest_history_168h.json "
            ...
            commands.extend(
                [
                    command_step(
                        ...
                        "python3 analysis/backtest.py --history runtime/latest_history_168h.json "
                    ...
                    command_step(
                        ...
                        "python3 analysis/weight_search.py --history runtime/latest_history_168h.json "
        ...
        commands.append(
            command_step(
                ...
                "python3 analysis/promotion_gate.py --output-json runtime/latest_promotion_gate.json "
        ...
        if "mt5_next_action_run_buy" in next_action_runner_stale_names or (
            ...
            commands.append(
                command_step(
                    ...
                    "python3 analysis/mt5_next_action_run.py --target score_weight_sample_collection "
                    "--focus-side buy "
            ...
            actions,
            {
                ...
                "commands": [
                    ...
                    command_step(
                        ...
                        "python3 analysis/mt5_back_forward_run.py --mode both "
    ...
    if back_forward_execution_requires_action or back_forward_decision_requires_action:
        ...
        execute_command = (
            ...
            or "python3 analysis/mt5_back_forward_run.py --mode both --execute --refresh-ready-status "
            "--timeout-seconds 3600 --since-minutes 240 --min-closed 30"
        )
        collect_only_command = (
            ...
            or "python3 analysis/mt5_back_forward_run.py --mode both --collect-only "
            "--timeout-seconds 3600 --since-minutes 240 --min-closed 30"
        )
