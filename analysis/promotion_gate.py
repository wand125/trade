        ...
        *(
            [
                check(
                    ...
                    "workspace mt5/TesterSets/*.set and MT5 MQL5/Profiles/Tester/*.set hashes match",
                )
            ]
        ...
        *(
            [
                check(
                    ...
                    "workspace mt5/TesterConfigs/*.ini and MT5 MQL5/Profiles/Tester/*.ini hashes match",
                )
            ]
...
def build_promotion_next_actions(report: dict[str, object]) -> list[dict[str, object]]:
    ...
    def mt5_tester_execution_requires_compile(execution: object) -> bool:
        if not isinstance(execution, dict):
            return False
        command_text = str(execution.get("command_text") or "")
        return "analysis/mt5_tester_run.py" in command_text and "--collect-only" not in command_text
    ...
    def mt5_status_watch_restart_execution_plan() -> dict[str, object]:
        ...
        command = [
            "python3",
            "analysis/mt5_tester_status_watch.py",
            "--interval-seconds",
            "60",
            "--heartbeat",
...
def execution_supports_tester_xml_rows(execution: dict[str, object]) -> bool:
    ...
    return "analysis/mt5_tester_run.py" in command or "analysis/mt5_tester_optimization_report.py" in command
    ...
    *,
    ...
    presets: dict[str, dict[str, str]] = {
        "next_optimization": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set",
            ...
            "output_set": "mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set",
        },
        "stable_candidate": {
            "config": "mt5/TesterConfigs/Swing_Evaluation_Trader_stable_candidate.ini",
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_stable_candidate_next.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_stable_candidate_next.set",
        ...
        "buy_refit": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set",
        ...
        "buy_entry_refit": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_entry_refit.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_entry_refit.set",
        ...
        "buy_hour03_validation": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_validation.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_validation.set",
        ...
        "buy_hour03_wide_stop_validation": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_wide_stop_validation.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_wide_stop_validation.set",
        ...
        "buy_hour03_wide_stop_calendar_validation": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_wide_stop_calendar_validation.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_wide_stop_calendar_validation.set",
        ...
        "sell_entry_refit": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_sell_entry_refit.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_sell_entry_refit.set",
        ...
        "sell_regime_entry_refit": {
            ...
            "set": "mt5/TesterSets/Swing_Evaluation_Trader_sell_regime_entry_refit.set",
            "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_sell_regime_entry_refit.set",
...
def mt5_strategy_forward_execution_plan(*, archive_run_id: str | None = None) -> dict[str, object]:
    ...
    set_path = "mt5/TesterSets/Swing_Evaluation_Trader_forward_test.set"
    config_path = "mt5/TesterConfigs/Swing_Evaluation_Trader_forward_test.ini"
    ...
    collect_command = [
        "python3",
        "analysis/mt5_forward_collect.py",
        "--destination",
...
def mt5_forward_old_loss_limit_fix_plan(detected_limits: object) -> dict[str, object] | None:
    ...
    if not old_limits:
        return None
    set_file = "mt5/TesterSets/Swing_Evaluation_Trader_forward_test.set"
...
def mt5_optimization_report_refresh_execution_plan(
    *,
    ...
    output_set: str = "mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set",
) -> dict[str, object]:
    set_path = "mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set"
    set_estimate: dict[str, object] = {}
    if Path(set_path).exists():
        set_estimate = estimate_set_passes(Path(set_path).read_text(encoding="utf-8"))
    ...
    report_command = [
        "python3",
        "analysis/mt5_tester_optimization_report.py",
        "--since-minutes",
        "240",
        "--min-closed",
        "100",
    ...
    recommend_command = [
        "python3",
        "analysis/mt5_optimization_recommend.py",
        "--input",
        optimization_json,
        "--min-segment-closed",
        "500",
...
def mt5_stable_candidate_set_execution_plan(*, focus_side: str = "auto") -> dict[str, object]:
    output_set = "mt5/TesterSets/Swing_Evaluation_Trader_stable_candidate_next.set"
    ...
    return {
        ...
        "set": output_set,
        "template_set": "mt5/TesterSets/Swing_Evaluation_Trader_optimization.set",
        "command": command,
        "command_text": command_text(command),
        "outputs": {
            "recommendation_json": recommendation_json,
...
def mt5_agent_csv_archive_execution_plan(
    *,
    ...
    command = [
        "python3",
        "analysis/mt5_agent_csv_archive.py",
        "--output-json",
        output_json,
        "--output-md",
        output_md,
...
def python_forward_execution_plan() -> dict[str, object]:
    command = [
        "python3",
        "analysis/forward_test_watch.py",
        "--signal",
        "runtime/latest_signal.json",
        "--ledger",
...
def score_weight_set_execution_plan(side: str) -> dict[str, object]:
    ...
    if focus_side == "sell":
        template_set = "mt5/TesterSets/Swing_Evaluation_Trader_sell_regime_entry_refit.set"
        output_set = "mt5/TesterSets/Swing_Evaluation_Trader_sell_score_weight_refit.set"
    elif focus_side == "buy":
        template_set = "mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set"
        output_set = "mt5/TesterSets/Swing_Evaluation_Trader_buy_score_weight_refit.set"
    else:
        template_set = "mt5/TesterSets/Swing_Evaluation_Trader_optimization.set"
        output_set = "mt5/TesterSets/Swing_Evaluation_Trader_score_weight_refit.set"
    command = [
        "python3",
        "analysis/score_weight_set.py",
        "--weight-search-json",
...
def score_weight_sample_collection_execution_plan(
    *,
    ...
    plan: dict[str, object] = {
        ...
        "optimization_mode": "single",
        "config": "mt5/TesterConfigs/Swing_Evaluation_Trader_sample_collection.ini",
        "set": "mt5/TesterSets/Swing_Evaluation_Trader_sample_collection.set",
        "report_name": report_name,
        "agent_csv_archive_run_id": archive_run_id,
        "outputs": {
            "run_json": run_json,
...
def backtest_sample_execution_plan() -> dict[str, object]:
    command = ["python3", "bridge/request_history.py", "168"]
    status_command = [
        "python3",
        "analysis/history_status.py",
        "--history",
...
def is_mt5_tester_run_execution(execution: dict[str, object]) -> bool:
    return "analysis/mt5_tester_run.py" in str(execution.get("command_text") or "")
