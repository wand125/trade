...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Refresh analysis/history_status.py before bridge_recovery_plan.py reads latest_history_status.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    while True:
        ...
        if not args.skip_recovery_plan:
            recovery_command = [
                sys.executable,
                "analysis/bridge_recovery_plan.py",
                "--bridge-status",
                args.output_json,
                "--history-status",
                args.history_status,
