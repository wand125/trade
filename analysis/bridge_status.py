...
def bridge_process_summary() -> dict[str, Any]:
    ...
    matches = [
        ...
        if "bridge/mt5_ai_bridge.py" in line or "mt5_ai_bridge.py" in line
    ]
...
def build_bridge_status(
    *,
    ...
    if operational_status == "bridge_unreachable":
        next_action = "Start or restart bridge/mt5_ai_bridge.py and verify /health and /config."
    elif operational_status == "bridge_process_not_found":
        next_action = "Start python3 bridge/mt5_ai_bridge.py."
