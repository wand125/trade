...
EA_PATH = Path("mt5/Experts/Swing_Evaluation_Trader.mq5")
BRIDGE_EA_PATH = Path("mt5/Experts/AI_Bridge_Advisor.mq5")
INDICATOR_PATH = Path("mt5/Indicators/Swing_Evaluation_Predictor.mq5")
FORWARD_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_forward_test.set")
BACKTEST_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_backtest.set")
SAMPLE_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_sample_collection.set")
OPTIMIZATION_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_optimization.set")
NEXT_OPTIMIZATION_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_next_optimization.set")
STABLE_CANDIDATE_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_stable_candidate_next.set")
BUY_REFIT_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_buy_refit.set")
BUY_ENTRY_REFIT_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_buy_entry_refit.set")
BUY_HOUR03_VALIDATION_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_buy_hour03_validation.set")
...
SELL_ENTRY_REFIT_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_sell_entry_refit.set")
SELL_REGIME_ENTRY_REFIT_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_sell_regime_entry_refit.set")
SELL_HOUR12_VALIDATION_SET_PATH = Path("mt5/TesterSets/Swing_Evaluation_Trader_sell_hour12_validation.set")
...
STRATEGY_TEST_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_strategy_test.ini")
BACKTEST_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_backtest.ini")
FORWARD_TEST_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_forward_test.ini")
SAMPLE_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_sample_collection.ini")
OPTIMIZATION_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_optimization.ini")
NEXT_OPTIMIZATION_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_next_optimization.ini")
STABLE_CANDIDATE_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_stable_candidate.ini")
BUY_REFIT_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_buy_refit.ini")
BUY_ENTRY_REFIT_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_buy_entry_refit.ini")
BUY_HOUR03_VALIDATION_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_buy_hour03_validation.ini")
...
SELL_ENTRY_REFIT_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_sell_entry_refit.ini")
SELL_REGIME_ENTRY_REFIT_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_sell_regime_entry_refit.ini")
SELL_HOUR12_VALIDATION_CONFIG_PATH = Path("mt5/TesterConfigs/Swing_Evaluation_Trader_sell_hour12_validation.ini")
