...
class Mt5StrategyTesterAnalysisTests(unittest.TestCase):
                    ...
                    "operation_cards": [
                        {
                            ...
                            "collect_command_text": (
                                ...
                                "--config mt5/TesterConfigs/Swing_Evaluation_Trader_sell_hour12_m30m15_validation.ini "
    ...
    def test_build_report_marks_plan_only_back_forward_as_not_ready(self):
        with tempfile.TemporaryDirectory() as tmpdir:
                ...
                root / "runtime" / "latest_mt5_back_forward_run.json",
                {
                    ...
                    "manual_strategy_tester": {
                        ...
                        "recommended_collect_only_command_text": (
                            "python3 analysis/mt5_back_forward_run.py --mode both --collect-only"
                        ),
                    },
                ...
                root / "runtime" / "latest_mt5_tester_status.json",
                {
                    ...
                    "mt5_operator_handoff": {
                        ...
                        "manual_collect_execute_and_refresh_analysis_command_text": (
                            "python3 analysis/mt5_manual_collect.py --execute "
                ...
                root / "runtime" / "latest_mt5_manual_test_queue_with_optimization.json",
                {
                    ...
                    "operation_cards": [
                        ...
                        },
                        {
                            ...
                            "collect_command_text": (
                                "python3 analysis/mt5_tester_run.py "
                                "--config mt5/TesterConfigs/Swing_Evaluation_Trader_optimization.ini "
                                "--collect-only"
                            ),
                        },
                        {
            ...
            self.assertIn("analysis/mt5_back_forward_run.py --mode both --collect-only", markdown)
            ...
            self.assertIn(
                "Refresh analysis command: `python3 analysis/mt5_strategy_tester_analysis.py "
            ...
            self.assertIn(
                "Static configs: mt5/TesterConfigs/Swing_Evaluation_Trader_optimization.ini",
                markdown,
            )
            ...
            self.assertIn("runner execute: python3 analysis/mt5_tester_run.py", markdown)
        ...
        decision = back_forward_decision_summary(
            {
                ...
                "recommended_collect_only_command_text": "python3 analysis/mt5_back_forward_run.py --collect-only",
            }
        )
    ...
    def test_script_name_is_referenceable_for_coverage_docs(self):
        self.assertIn("mt5_strategy_tester_analysis.py", "analysis/mt5_strategy_tester_analysis.py")
